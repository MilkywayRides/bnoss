 ...
 * shadcn dark theme with transparent background.
 */
...
int main(int argc, char *argv[]) {
    ...
    blazeneuro_style_window(win, "app-terminal");
    ...
    /* Colors — shadcn zinc dark theme */
    GdkRGBA fg = {0.98, 0.98, 0.98, 1.0};       /* #fafafa */
    GdkRGBA bg = {0.035, 0.035, 0.043, 0.88};    /* #09090b transparent */

    GdkRGBA palette[16] = {
        {0.15, 0.15, 0.16, 1},   /* 0  black    #27272a */
        {0.94, 0.33, 0.33, 1},   /* 1  red      */
        {0.40, 0.85, 0.55, 1},   /* 2  green    */
        {0.98, 0.78, 0.35, 1},   /* 3  yellow   */
        {0.23, 0.51, 0.96, 1},   /* 4  blue     */
        {0.69, 0.40, 0.96, 1},   /* 5  magenta  */
        {0.30, 0.82, 0.88, 1},   /* 6  cyan     */
        {0.83, 0.83, 0.85, 1},   /* 7  white    #d4d4d8 */
        {0.35, 0.35, 0.39, 1},   /* 8  brblack  #52525b */
        {1.00, 0.45, 0.45, 1},   /* 9  brred    */
        {0.50, 0.95, 0.65, 1},   /* 10 brgreen  */
        {1.00, 0.88, 0.45, 1},   /* 11 bryellow */
        {0.45, 0.65, 1.00, 1},   /* 12 brblue   */
        {0.80, 0.55, 1.00, 1},   /* 13 brmagenta*/
        {0.45, 0.92, 0.98, 1},   /* 14 brcyan   */
        {0.98, 0.98, 0.98, 1},   /* 15 brwhite  #fafafa */
    };
